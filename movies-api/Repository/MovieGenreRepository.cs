...
namespace movies_api.Repository
{
    public class MovieGenreRepository : IMovieGenreRepository
    {
        ...
        .Where(m => m.MovieGenre
            // Checks if there is at least one element in a collection that matches a condition.
            // returns true or false
            .Any(mg => mg.Genre.GenreName.ToLower() == query.GenreName.ToLower()))
