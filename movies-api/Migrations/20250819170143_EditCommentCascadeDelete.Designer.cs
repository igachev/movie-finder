...
namespace movies_api.Migrations
{
    ...
    [Migration("20250819170143_EditCommentCascadeDelete")]
    partial class EditCommentCascadeDelete
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("movies_api.Models.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("movies_api.Models.MovieGenre", b =>
                {
                    b.Property<int>("MovieId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("movies_api.Models.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("movies_api.Models.Comment", b =>
                {
                    b.HasOne("movies_api.Models.AppUser", "AppUser")
                        .WithMany()
